...
namespace SplatoonPainter
{
    public class PaintManager : Singleton<PaintManager>
    {
        ...
        public void Paint(Paintable paintable, ref SimplePaintBrush brush)
        {
            ...
            TexturePainter.SetVector(brushcolorID, brush.color);
            TexturePainter.SetVector(brushpositionID, brush.position);
            TexturePainter.SetFloat(brushradiusID, brush.radius);

...
public class PaintCalculator : MonoBehaviour
{
    ...
    [SerializeField] public Color[] teamColors = new Color[4]; 
    [SerializeField] [Range(1, 4)] public int numberOfColors = 1;
    [SerializeField] public List<int> colorCounterList = new List<int>();
    ...
    public void onPaintableAdded(Paintable paintable)
    {
